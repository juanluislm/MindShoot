...
public class CombineChildren : MonoBehaviour {
	...
	/// Usually rendering with triangles is faster.
	/// However when combining few large objects triangle strips might be faster.
		...
		for (int i=0;i<filters.Length;i++) {
			...
			if (curRenderer != null && curRenderer.enabled && instance.mesh != null) {
				...
				for (int m=0;m<materials.Length;m++) {
					instance.subMeshIndex = System.Math.Max(instance.subMeshIndex, instance.mesh.subMeshCount - 1);
